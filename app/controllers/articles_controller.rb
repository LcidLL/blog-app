class ArticlesController < ApplicationController
  ...
  def create
    ...
    if @article.save
      ...
      flash.now[:error] = "There was an error creating the article. Please check the form below."
  ...
  def update
    ...
    if @article.update(article_params)
      ...
      flash.now[:error] = "There was an error updating the article. Please check the form below."
